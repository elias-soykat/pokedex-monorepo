...
import { getPokemonListRequest, getPokemonDetailsRequest } from '@/lib/requests/pokemon-request'
...
export const fetchPokemonDetail = createAsyncThunk<TPokemonDetails | null, number>(
  POKEMON_ACTION.FETCH_DETAILS,
  async (id, { dispatch }) => {
    try {
